...
//    }
//    
//    public ExcelHelper(String[] head)
//    {
//        // 创建新的工作簿
...
//        // 设置内容样式
//        setBodyCellStyle();
//        this.initHeader(sheet[0],head);
//    }
//    
//    public ExcelHelper(String[] sheetArr,String[] head)
//    {
//        // 创建新的工作簿
//        workbook = new HSSFWorkbook();
//        // 在工作簿中创建一工作表
//        for(int i = 0;i<sheet.length;i++){
//        	sheet[i] = workbook.createSheet(sheetArr[i]);
//        	this.initHeader(sheet[i],head);
//        }
//        // 设置标题样式
//        setHeadCellStyle();
//        // 设置内容样式
...
//    
//    // 初始化报表的头信息
//    private void initHeader(HSSFSheet sheet,String[] head)
//    {
//        HSSFRow row = sheet.createRow(0);
//        this.header = head;
//        for(int i = 0; i < header.length; i++)
